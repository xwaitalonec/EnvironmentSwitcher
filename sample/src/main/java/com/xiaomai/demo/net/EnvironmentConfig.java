...
public class EnvironmentConfig {
    ...
    @Module
    private class App {
        @Environment(url = "https://gank.io/api/", isRelease = true, alias = "正式", host = "host1")
    ...
    @Module(alias = "音乐")
    private class Music {
        @Environment(url = "https://www.codexiaomai.top/api/", isRelease = true, alias = "正式", host = "host2", imUrl = "im2")
        private String online;

        @Environment(url = "http://test.codexiaomai.top/api/", alias = "测试", host = "host3", imUrl = "im3")
        private String test;
    }
    ...
    @Module(alias = "新闻")
    private class News {
        @Environment(url = "http://news/release/", isRelease = true, alias = "正式", host = "4")
        private String release;

        @Environment(url = "http://news/test/", alias = "测试", host = "5")
        private String test;
